...
## [0.1.37](https://github.com/knqiufan/deepagents/compare/deepagents-code==0.1.36...deepagents-code==0.1.37) (2026-07-10)


### Features

* **code,quickjs:** dynamic subagents UI ([#4221](https://github.com/knqiufan/deepagents/issues/4221)) ([10bcba2](https://github.com/knqiufan/deepagents/commit/10bcba25600e51aba135f170b34aa6315c0f53d6))
* **code,sdk:** add rubric iteration controls ([#4405](https://github.com/knqiufan/deepagents/issues/4405)) ([d6692a7](https://github.com/knqiufan/deepagents/commit/d6692a7c713490f170b17510d613e02ee37574ab))
* **code:** `dcode doctor` diagnostics command ([#4148](https://github.com/knqiufan/deepagents/issues/4148)) ([8179731](https://github.com/knqiufan/deepagents/commit/81797312c7d857e7d94d03c9c695cd3c8d88799a))
* **code:** `tool.use` and `tool.result` hook events ([#3954](https://github.com/knqiufan/deepagents/issues/3954)) ([ba1979d](https://github.com/knqiufan/deepagents/commit/ba1979d64c3ed5e96ebc896197bc8f97f6f84bac))
* **code:** add `[startup].mode` default approval mode ([#4573](https://github.com/knqiufan/deepagents/issues/4573)) ([7c5bf54](https://github.com/knqiufan/deepagents/commit/7c5bf542c2f58fa46ecd708c66cd1817a0ebdc41))
* **code:** add `dcode tools list` command ([#4461](https://github.com/knqiufan/deepagents/issues/4461)) ([1402d0e](https://github.com/knqiufan/deepagents/commit/1402d0e735a1580503f240457c77db76fcd779d7))
* **code:** add `GPT-5.6` model family ([#4600](https://github.com/knqiufan/deepagents/issues/4600)) ([4a806bc](https://github.com/knqiufan/deepagents/commit/4a806bc703b69334cccd05bcd27d411602e82318))
* **code:** add agent filter dropdown to `/threads` picker ([#3677](https://github.com/knqiufan/deepagents/issues/3677)) ([f8193df](https://github.com/knqiufan/deepagents/commit/f8193df41d7c47626d94252039217f4079d117cd))
* **code:** add Claude Sonnet 5 to model picker ([#4386](https://github.com/knqiufan/deepagents/issues/4386)) ([64758dd](https://github.com/knqiufan/deepagents/commit/64758dddf8b46c5b68c345fb1eac1fb7bcbf7f7e))
* **code:** add Deep Agents client version metadata ([#3934](https://github.com/knqiufan/deepagents/issues/3934)) ([058cec6](https://github.com/knqiufan/deepagents/commit/058cec654645dd1a504408d712ab678edc48273d))
* **code:** add Fireworks session settings ([#4360](https://github.com/knqiufan/deepagents/issues/4360)) ([90ebb1d](https://github.com/knqiufan/deepagents/commit/90ebb1d68cb5942f07847f6dce48c14c7caef992))
* **code:** add Grok 4.5 model ([#4596](https://github.com/knqiufan/deepagents/issues/4596)) ([b0a209d](https://github.com/knqiufan/deepagents/commit/b0a209da3a8c9f80e2e3d5e199340736c854c567))
* **code:** add LangSmith base URL to `/auth` ([#4228](https://github.com/knqiufan/deepagents/issues/4228)) ([88d167f](https://github.com/knqiufan/deepagents/commit/88d167f9ceec1cfadd7c3feac6f63c0da7c893f1))
* **code:** add LangSmith tracing config to `/auth` ([#4193](https://github.com/knqiufan/deepagents/issues/4193)) ([8e62957](https://github.com/knqiufan/deepagents/commit/8e6295791093c2ddfec7e6ac57f0df7f12048447))
* **code:** add latest frontier models to recommended list ([#4045](https://github.com/knqiufan/deepagents/issues/4045)) ([1145356](https://github.com/knqiufan/deepagents/commit/114535637eaee383c64eac5282bc9ac57007c83f))
* **code:** add Opus 4.8 to recommended models ([#4204](https://github.com/knqiufan/deepagents/issues/4204)) ([8faf2b0](https://github.com/knqiufan/deepagents/commit/8faf2b025f8429481a41a3e65544d26614e53589))
* **code:** add pre-release update support ([#3960](https://github.com/knqiufan/deepagents/issues/3960)) ([341a5cc](https://github.com/knqiufan/deepagents/commit/341a5cc55a30d808dbb366b396923c7801c431d2))
* **code:** add provider-specific auth guidance ([#4004](https://github.com/knqiufan/deepagents/issues/4004)) ([6a39247](https://github.com/knqiufan/deepagents/commit/6a392471ba30089b1a63135494873d55209bb081))
* **code:** add reasoning effort selector ([#4403](https://github.com/knqiufan/deepagents/issues/4403)) ([6ee0ac4](https://github.com/knqiufan/deepagents/commit/6ee0ac4cca998f84e157187d565084e2a1912626))
* **code:** add rubric-backed goal workflow ([#4365](https://github.com/knqiufan/deepagents/issues/4365)) ([8fca61d](https://github.com/knqiufan/deepagents/commit/8fca61dc036888a4414ff5a4536b957c63dab4a5))
* **code:** add structured TUI display for `js_eval` ([#4151](https://github.com/knqiufan/deepagents/issues/4151)) ([91c0dae](https://github.com/knqiufan/deepagents/commit/91c0dae3fe0253f02a5926fcd3c6f796cd8d11fe))
* **code:** adopt coding-agent-v1 trace metadata ([#4367](https://github.com/knqiufan/deepagents/issues/4367)) ([cb39747](https://github.com/knqiufan/deepagents/commit/cb3974748024fcec2e2ee0ccc0a9b23c880733a2))
* **code:** allow dependency updates without requiring release ([#4157](https://github.com/knqiufan/deepagents/issues/4157)) ([7beb97a](https://github.com/knqiufan/deepagents/commit/7beb97a2b02e2fd238baf3b6f05d43a4accf3f42))
* **code:** auto-detect MCP OAuth from 401 challenge ([#4364](https://github.com/knqiufan/deepagents/issues/4364)) ([9763ffc](https://github.com/knqiufan/deepagents/commit/9763ffceab8800526ae9fe10decdb2f32d8e4707))
* **code:** auto-retry credentials-blocked startup after `/auth` ([#4176](https://github.com/knqiufan/deepagents/issues/4176)) ([d10ba3d](https://github.com/knqiufan/deepagents/commit/d10ba3dc162e47cc71df56b8e3d0000b6e0ed847))
* **code:** ChatGPT OAuth sign-in for Codex models ([#3532](https://github.com/knqiufan/deepagents/issues/3532)) ([202e0bd](https://github.com/knqiufan/deepagents/commit/202e0bd3e5b8b874a69656815489308d75a77d05))
* **code:** clear chat input via `esc+esc`, add `[ X ]/[ COPY ]` buttons ([#4000](https://github.com/knqiufan/deepagents/issues/4000)) ([c20546f](https://github.com/knqiufan/deepagents/commit/c20546feac7876786e6816776d1ccfa5fcd4b2c8))
* **code:** collapse completed tool calls into group summaries ([#4373](https://github.com/knqiufan/deepagents/issues/4373)) ([3735829](https://github.com/knqiufan/deepagents/commit/3735829a0c14fb1537daf930140c66b647c8222c))
* **code:** collapse large pastes into compact placeholders ([#4447](https://github.com/knqiufan/deepagents/issues/4447)) ([9ae927d](https://github.com/knqiufan/deepagents/commit/9ae927d73ebf30ba50bbb7ec0c1076a0937e5cb7))
* **code:** collect Tavily key during onboarding ([#4233](https://github.com/knqiufan/deepagents/issues/4233)) ([e321cba](https://github.com/knqiufan/deepagents/commit/e321cba5701313e974f979069186680f1a39587c))
* **code:** confirm "Launched" after auto-update restart ([#4098](https://github.com/knqiufan/deepagents/issues/4098)) ([df8db8a](https://github.com/knqiufan/deepagents/commit/df8db8af6a7cbfc2ab535020b951d73759da73dd))
* **code:** dual-write agent traces to extra LangSmith projects ([#3998](https://github.com/knqiufan/deepagents/issues/3998)) ([1b94cf3](https://github.com/knqiufan/deepagents/commit/1b94cf322949e0cafd6f2bacf343fb0044ec5a8c))
* **code:** enable `js_eval` by default ([#4245](https://github.com/knqiufan/deepagents/issues/4245)) ([2e04ff3](https://github.com/knqiufan/deepagents/commit/2e04ff397e60389c9a19c4a9b528e15602ad8338))
* **code:** fall back to folder name for subagents ([#4504](https://github.com/knqiufan/deepagents/issues/4504)) ([9db3db5](https://github.com/knqiufan/deepagents/commit/9db3db5f31a93fb8598a5dc5bedf4fe61fe92c94))
* **code:** gate onboarding integrations modal behind opt-in flag ([#4227](https://github.com/knqiufan/deepagents/issues/4227)) ([6c930c5](https://github.com/knqiufan/deepagents/commit/6c930c5e4502f572be554acc896c5fb6d061e0e5))
* **code:** gate paste auto-collapse behind `display.collapse_pastes` ([#4473](https://github.com/knqiufan/deepagents/issues/4473)) ([ff5dd56](https://github.com/knqiufan/deepagents/commit/ff5dd564a3a590e7d2d521b20df495b5e1512e12))
* **code:** improve onboarding Installed Integrations screen ([#4195](https://github.com/knqiufan/deepagents/issues/4195)) ([0827bf1](https://github.com/knqiufan/deepagents/commit/0827bf1b635b825121740ac8946dd6d98c815c7d))
* **code:** in-the-moment trust prompt for symlinked skills ([#4200](https://github.com/knqiufan/deepagents/issues/4200)) ([a4431e4](https://github.com/knqiufan/deepagents/commit/a4431e4339348431e91533cb2b177259ab94b083))
* **code:** make auto-update opt-out by default ([#3994](https://github.com/knqiufan/deepagents/issues/3994)) ([7ff6e22](https://github.com/knqiufan/deepagents/commit/7ff6e2224d7ba8462c073333da937c35831f9b34))
* **code:** manage Tavily web-search API key in `/auth` ([#4062](https://github.com/knqiufan/deepagents/issues/4062)) ([90cc099](https://github.com/knqiufan/deepagents/commit/90cc099b0998a9aa55df01e3bc12ad1597c65365))
* **code:** non-interactive `deepagents auth` subcommands ([#3910](https://github.com/knqiufan/deepagents/issues/3910)) ([11a71bb](https://github.com/knqiufan/deepagents/commit/11a71bbf00c4e6c1f989e70fb3472a65c8d39662))
* **code:** non-interactive rubric grading flags ([#4305](https://github.com/knqiufan/deepagents/issues/4305)) ([1bcb112](https://github.com/knqiufan/deepagents/commit/1bcb112ee78138eca9cb400c206ce198322aae32))
* **code:** note minimum OpenAI key permissions in `/auth` ([#4040](https://github.com/knqiufan/deepagents/issues/4040)) ([14be63d](https://github.com/knqiufan/deepagents/commit/14be63d476ed8dece75e20fff05016122c258be8))
* **code:** offer abort during resume ([#4188](https://github.com/knqiufan/deepagents/issues/4188)) ([a4c25cd](https://github.com/knqiufan/deepagents/commit/a4c25cd74de9902fd0ea9440b5dda2d4248bb3d2))
* **code:** offer restart after saving Tavily key via `/auth` ([#4560](https://github.com/knqiufan/deepagents/issues/4560)) ([12df81a](https://github.com/knqiufan/deepagents/commit/12df81ad00d814c570b4d24a2b06de9b18d51abd))
* **code:** persistent banner when installation is stale ([#4459](https://github.com/knqiufan/deepagents/issues/4459)) ([b74c185](https://github.com/knqiufan/deepagents/commit/b74c18591a8ce9a49a5fee43b07e602ca9fbf68a))
* **code:** prompt before updating an out-of-date dcode install ([#3995](https://github.com/knqiufan/deepagents/issues/3995)) ([a5ec6dd](https://github.com/knqiufan/deepagents/commit/a5ec6dd0fec66ad321c1cc0f5e2f990c9026e03f))
* **code:** prompt to install provider when selecting an uninstalled model ([#3981](https://github.com/knqiufan/deepagents/issues/3981)) ([619207c](https://github.com/knqiufan/deepagents/commit/619207c8d4d4308a9a3ab9d2d039506feeaf8a67))
* **code:** quiet install script's full dependency list ([#4058](https://github.com/knqiufan/deepagents/issues/4058)) ([de2c9fd](https://github.com/knqiufan/deepagents/commit/de2c9fd8c7437fdcdfe738599f83808c5423c55c))
* **code:** quit shortcut on completed update modal ([#4312](https://github.com/knqiufan/deepagents/issues/4312)) ([5e6eae9](https://github.com/knqiufan/deepagents/commit/5e6eae9f094a5167b6bf01f2d84cf06ca5cd80c3))
* **code:** reload env from `/auth` modal via Ctrl+R ([#4566](https://github.com/knqiufan/deepagents/issues/4566)) ([f07d638](https://github.com/knqiufan/deepagents/commit/f07d6387b7dc1f0e880f77784905c2aa94143adb))
* **code:** report tracing gateway in `dcode doctor` ([#4466](https://github.com/knqiufan/deepagents/issues/4466)) ([a912427](https://github.com/knqiufan/deepagents/commit/a9124275504bc1af5f76dfdd9a6c558c98eea92d))
* **code:** restore interrupted prompt to input on ESC ([#4544](https://github.com/knqiufan/deepagents/issues/4544)) ([fccf037](https://github.com/knqiufan/deepagents/commit/fccf03732140d39749e70e8fc6cb7d73124a1d70))
* **code:** selective per-server project MCP trust ([#4507](https://github.com/knqiufan/deepagents/issues/4507)) ([aaa22a9](https://github.com/knqiufan/deepagents/commit/aaa22a9340cb3d2c8e9ce1a921957d0a9121da20))
* **code:** show `"Took <duration>"` after `execute` finishes ([#4301](https://github.com/knqiufan/deepagents/issues/4301)) ([a5240eb](https://github.com/knqiufan/deepagents/commit/a5240ebe3654e72fa5beb4070224f52f944768c8))
* **code:** show last update check time in `dcode doctor` ([#4307](https://github.com/knqiufan/deepagents/issues/4307)) ([b669f37](https://github.com/knqiufan/deepagents/commit/b669f37fb08998cfbf983da76f57822215614e7b))
* **code:** show model name instead of spec in switcher ([#4460](https://github.com/knqiufan/deepagents/issues/4460)) ([0059620](https://github.com/knqiufan/deepagents/commit/005962088ad31b16745c399e4ab2e725e97f7858))
* **code:** show provider in usage stats table ([#4049](https://github.com/knqiufan/deepagents/issues/4049)) ([309b054](https://github.com/knqiufan/deepagents/commit/309b054fdd040adb5086408a3bcb2550ba73439e))
* **code:** simplify welcome banner to compact box ([#4482](https://github.com/knqiufan/deepagents/issues/4482)) ([b7f46e9](https://github.com/knqiufan/deepagents/commit/b7f46e931807f86476c9c2d661dcd4e9623c10a2))
* **code:** surface `/auth` in `/trace not-configured` hint ([#4206](https://github.com/knqiufan/deepagents/issues/4206)) ([392e410](https://github.com/knqiufan/deepagents/commit/392e410e48639a56fda5e35b6f7f85a5215cce9c))
* **code:** surface editable mode and core deps in `/version` ([#3898](https://github.com/knqiufan/deepagents/issues/3898)) ([d4f5a12](https://github.com/knqiufan/deepagents/commit/d4f5a12cc6d73dc19d24d5748242705d79fa65bf))
* **code:** surface tracing in `doctor` and `config show` ([#4163](https://github.com/knqiufan/deepagents/issues/4163)) ([2bb3e44](https://github.com/knqiufan/deepagents/commit/2bb3e44243553a5f2954a0f3ec42364563842a87))
* **code:** surface uninstalled known providers in `/auth` menu ([#4059](https://github.com/knqiufan/deepagents/issues/4059)) ([73db271](https://github.com/knqiufan/deepagents/commit/73db2719bce5ad3c933ffee643df4a62cfd60e17))
* **code:** toast on saved `/auth` API key ([#4558](https://github.com/knqiufan/deepagents/issues/4558)) ([ee3c264](https://github.com/knqiufan/deepagents/commit/ee3c26415be84e369b829fefb21461c8ec210a5e))
* **code:** toast when opening a clicked URL ([#4368](https://github.com/knqiufan/deepagents/issues/4368)) ([434f29e](https://github.com/knqiufan/deepagents/commit/434f29e5cb3d94988e2a4d80b78452bee4b10812))
* **code:** unify `config show`/`list` around effective values ([#4174](https://github.com/knqiufan/deepagents/issues/4174)) ([ccd9d21](https://github.com/knqiufan/deepagents/commit/ccd9d216e77855a28b88850beb525f47ce8b686a))
* **code:** warn on `--interpreter-tools` without `--interpreter` ([#3976](https://github.com/knqiufan/deepagents/issues/3976)) ([e68e720](https://github.com/knqiufan/deepagents/commit/e68e720e2c3caa4e4e7c5e937faf718db7ad2e98))
* **sdk:** optional video frame extraction on `read_file` ([#4094](https://github.com/knqiufan/deepagents/issues/4094)) ([b927147](https://github.com/knqiufan/deepagents/commit/b927147d026749c6c790bb06c9853515dabf579c))
* **vercel:** add Vercel Sandbox provider ([#3588](https://github.com/knqiufan/deepagents/issues/3588)) ([e5e4748](https://github.com/knqiufan/deepagents/commit/e5e4748cb6c66ddaa9444ab464990c1a5d10854d))


### Bug Fixes

* **code:** `--reinstall` on `/install` so upgrades rebuild a clean env ([#4196](https://github.com/knqiufan/deepagents/issues/4196)) ([5e152ac](https://github.com/knqiufan/deepagents/commit/5e152ac0256d64376f96b293f8844bc8acc993ec))
* **code:** `dcode doctor` shows `not configured` for unset tracing ([#4318](https://github.com/knqiufan/deepagents/issues/4318)) ([e323d0c](https://github.com/knqiufan/deepagents/commit/e323d0c7d91f3b11e03a016c14cf52008dc66b55))
* **code:** allow `/remember` with args when no conversation history ([#4418](https://github.com/knqiufan/deepagents/issues/4418)) ([5df9c83](https://github.com/knqiufan/deepagents/commit/5df9c83b58f2529561848ae9f1364961e1c80641))
* **code:** allow suppressing LangSmith key override warning ([#4436](https://github.com/knqiufan/deepagents/issues/4436)) ([ddcae5e](https://github.com/knqiufan/deepagents/commit/ddcae5e0bd9aebc946be1d9fb3f5e35eeb690fa6))
* **code:** avoid blocking MCP imports during graph readiness ([#4302](https://github.com/knqiufan/deepagents/issues/4302)) ([7533ca8](https://github.com/knqiufan/deepagents/commit/7533ca89f3afc9863ba5e1ecee2d4c5974dea320))
* **code:** avoid duplicate "criteria ready" message on `/goal` revisions ([#4559](https://github.com/knqiufan/deepagents/issues/4559)) ([1110497](https://github.com/knqiufan/deepagents/commit/1110497e17fac6deceb9d1d6e530f9197bfc0d4a))
* **code:** bake release commit into `dcode doctor` ([#4225](https://github.com/knqiufan/deepagents/issues/4225)) ([6dc0246](https://github.com/knqiufan/deepagents/commit/6dc0246f5c6e9170e05191e1c82fad6975ac945c))
* **code:** bind ephemeral port instead of squatting `langgraph dev`'s 2024 ([#4264](https://github.com/knqiufan/deepagents/issues/4264)) ([11e5359](https://github.com/knqiufan/deepagents/commit/11e5359851f0291783661b4311ad5e4436a36fb7))
* **code:** block dotenv shell startup hooks ([#4288](https://github.com/knqiufan/deepagents/issues/4288)) ([686d6f3](https://github.com/knqiufan/deepagents/commit/686d6f3a1da8b6393efb4c0cf87b3eb35e0cca50))
* **code:** clarify managed `rg` install failures ([#4578](https://github.com/knqiufan/deepagents/issues/4578)) ([434c84a](https://github.com/knqiufan/deepagents/commit/434c84ae144b0319afe37d6f2dbadfd7f5fc9f70))
* **code:** clarify post-update restart semantics ([6318b81](https://github.com/knqiufan/deepagents/commit/6318b817399f7dd2f2e6dc07987dca46f1da9886))
* **code:** clear stale live approval mode keys ([#4242](https://github.com/knqiufan/deepagents/issues/4242)) ([f11a769](https://github.com/knqiufan/deepagents/commit/f11a76962c9d536a38e27ac05b32feca364b2424))
* **code:** clear transient update launch status ([#4355](https://github.com/knqiufan/deepagents/issues/4355)) ([b870b18](https://github.com/knqiufan/deepagents/commit/b870b18750f65442009028a85a2ac18f1b06640c))
* **code:** clearer MCP config JSON parse errors ([#4327](https://github.com/knqiufan/deepagents/issues/4327)) ([9cee602](https://github.com/knqiufan/deepagents/commit/9cee60274d38d4ad8a2d7a7e9d3ae59aebce5261))
* **code:** dedupe update/install log path output ([#4553](https://github.com/knqiufan/deepagents/issues/4553)) ([1398fee](https://github.com/knqiufan/deepagents/commit/1398feeca507cab9ec51a66604d46c747f7fcd2f))
* **code:** defer server graph construction ([#4300](https://github.com/knqiufan/deepagents/issues/4300)) ([220dfc0](https://github.com/knqiufan/deepagents/commit/220dfc0e6b03f9ccb499c6b850c586b9d57cc077))
* **code:** don't move cursor on click that re-focuses terminal ([#3893](https://github.com/knqiufan/deepagents/issues/3893)) ([b76788b](https://github.com/knqiufan/deepagents/commit/b76788b7850e910fe2882cb1a62ffff6ff5085b0))
* **code:** drop duplicate token-request `client_id` under Basic auth ([#4323](https://github.com/knqiufan/deepagents/issues/4323)) ([426dfad](https://github.com/knqiufan/deepagents/commit/426dfad3ea1e453914cb87efa8fc70fb85a9efcb))
* **code:** drop redundant version from "already up to date" message ([#4223](https://github.com/knqiufan/deepagents/issues/4223)) ([5d080df](https://github.com/knqiufan/deepagents/commit/5d080df2776d380214bf20ae31266b9628e4e5b0))
* **code:** eager managed ripgrep install via `dcode tools install` ([#4199](https://github.com/knqiufan/deepagents/issues/4199)) ([cf536f3](https://github.com/knqiufan/deepagents/commit/cf536f339958d6726fa41f896c4a3e42df644c9f))
* **code:** ensure unique message widget IDs on history load ([#4454](https://github.com/knqiufan/deepagents/issues/4454)) ([de2f7d2](https://github.com/knqiufan/deepagents/commit/de2f7d2835485df905772e1c96e33d2c239d8e22))
* **code:** exclude managed bin dir from agent picker ([#4190](https://github.com/knqiufan/deepagents/issues/4190)) ([d869d1e](https://github.com/knqiufan/deepagents/commit/d869d1e1fa8558510fb48e71f78fb74c69ca4840))
* **code:** exclude prompt prefix from `UserMessage` selection ([#4002](https://github.com/knqiufan/deepagents/issues/4002)) ([8ee6ba6](https://github.com/knqiufan/deepagents/commit/8ee6ba6e64895d3d36a5957627221ed7667bc1d4))
* **code:** full-width chat messages, hide scrollbar, flush input bg ([#4374](https://github.com/knqiufan/deepagents/issues/4374)) ([1f8e8dc](https://github.com/knqiufan/deepagents/commit/1f8e8dc942ac54c4014ac48f9345ee0201be0b1b))
* **code:** gate `delete` file operations ([#4299](https://github.com/knqiufan/deepagents/issues/4299)) ([92a8681](https://github.com/knqiufan/deepagents/commit/92a86819adfefbc6ccfd01a861191ba292eca754))
* **code:** generic "missing credentials" in model switcher ([#4182](https://github.com/knqiufan/deepagents/issues/4182)) ([456ce5c](https://github.com/knqiufan/deepagents/commit/456ce5c2f5487a754d1fea7046e32c03b7e27a17))
* **code:** guard against misconfigured LangSmith tracing ([#3993](https://github.com/knqiufan/deepagents/issues/3993)) ([81acc2e](https://github.com/knqiufan/deepagents/commit/81acc2ecdada55a98e512f96b0caf8cb0f2c6d29))
* **code:** guard restart-prompt import against in-place self-upgrade ([#3980](https://github.com/knqiufan/deepagents/issues/3980)) ([7af13f6](https://github.com/knqiufan/deepagents/commit/7af13f6ec2440c2e3eb63bad2ff31e809f772804))
* **code:** handle LangSmith project-not-found and default tracing project ([#4153](https://github.com/knqiufan/deepagents/issues/4153)) ([e303ce9](https://github.com/knqiufan/deepagents/commit/e303ce986a3595f0cf458e796d857f7c8f5f8b5c))
* **code:** handle recursive `fetch_url` conversion ([#4257](https://github.com/knqiufan/deepagents/issues/4257)) ([f240a40](https://github.com/knqiufan/deepagents/commit/f240a40dc05d812c38e9926c1d81ba38deb86e3f))
* **code:** harden approval content rendering ([#4581](https://github.com/knqiufan/deepagents/issues/4581)) ([38446fd](https://github.com/knqiufan/deepagents/commit/38446fda649b891dd8604e788701eabe739c1dd0))
* **code:** hide "Recent" section during onboarding model selection ([#4198](https://github.com/knqiufan/deepagents/issues/4198)) ([af882e4](https://github.com/knqiufan/deepagents/commit/af882e4f6c859878e350d8a37bb75b7bc01bb453))
* **code:** hide `[SYSTEM]` interrupt notices from `/threads` prompt ([#3988](https://github.com/knqiufan/deepagents/issues/3988)) ([68fa0cb](https://github.com/knqiufan/deepagents/commit/68fa0cb4d48ff3f3e552bbf16f8316433c7b6f34))
* **code:** hide chat input action buttons in same frame as empty draft ([#4178](https://github.com/knqiufan/deepagents/issues/4178)) ([f94d417](https://github.com/knqiufan/deepagents/commit/f94d417d5ad9928db967777fe1d7bc2c37684fb9))
* **code:** highlight just-installed provider on `/auth` reopen ([#4311](https://github.com/knqiufan/deepagents/issues/4311)) ([85e47b5](https://github.com/knqiufan/deepagents/commit/85e47b532b5caf92a52f1a070a95bdb39bee6d3d))
* **code:** honest MCP OAuth callback close message ([#4410](https://github.com/knqiufan/deepagents/issues/4410)) ([ef637f4](https://github.com/knqiufan/deepagents/commit/ef637f4a3f38ee155ad7d31e64a5cdd7bfaee62c))
* **code:** honor Baseten base URL env precedence ([#4328](https://github.com/knqiufan/deepagents/issues/4328)) ([8f20d74](https://github.com/knqiufan/deepagents/commit/8f20d74892112c3b88aaca63d8c04a355fd6726f))
* **code:** include skill invocations in input history ([#4211](https://github.com/knqiufan/deepagents/issues/4211)) ([7b8d0b2](https://github.com/knqiufan/deepagents/commit/7b8d0b2ec184e0d9a0cbe858a0d9a7128791969d))
* **code:** interrupt remote runs on chat cancellation ([#4234](https://github.com/knqiufan/deepagents/issues/4234)) ([37c5fa2](https://github.com/knqiufan/deepagents/commit/37c5fa23e621616836694bc59c1b0c38def81604))
* **code:** keep auth modal interactive after install-on-select ([#4187](https://github.com/knqiufan/deepagents/issues/4187)) ([afbc56a](https://github.com/knqiufan/deepagents/commit/afbc56a1d9dbe8a89015f4c2f90bb87547d5c1d4))
* **code:** keep footer branch visible and ellipsized instead of hiding when narrow ([#4506](https://github.com/knqiufan/deepagents/issues/4506)) ([ccf30c3](https://github.com/knqiufan/deepagents/commit/ccf30c342e5ead677aafd196d8f1ddd2bdf95196))
* **code:** keep install-required `/model` rows dimmed after navigation ([#4048](https://github.com/knqiufan/deepagents/issues/4048)) ([c499634](https://github.com/knqiufan/deepagents/commit/c499634c530dcab9b18e3126b4573ff0d36c3efa))
* **code:** keep notification center open for API-key entry ([#4568](https://github.com/knqiufan/deepagents/issues/4568)) ([6e89417](https://github.com/knqiufan/deepagents/commit/6e8941776cdcc35909da305f3bb39500c0f479cb))
* **code:** label `-r` resume as `"Resuming..."` in the status bar ([#3892](https://github.com/knqiufan/deepagents/issues/3892)) ([70cd286](https://github.com/knqiufan/deepagents/commit/70cd28643bc2ca7da5a61a7b7203c6de2266ca4e))
* **code:** make `/timestamps` toggle instant via per-footer class ([#4095](https://github.com/knqiufan/deepagents/issues/4095)) ([7ae32b0](https://github.com/knqiufan/deepagents/commit/7ae32b0a606cc200d4311e11036a65f17e8282b3))
* **code:** make execute command expandable in code TUI transcript ([#4428](https://github.com/knqiufan/deepagents/issues/4428)) ([d999181](https://github.com/knqiufan/deepagents/commit/d999181e8424498681f1e442c71380bf6b82b0aa))
* **code:** note subscription plans unusable for Anthropic in `/auth` ([#4207](https://github.com/knqiufan/deepagents/issues/4207)) ([28cd19d](https://github.com/knqiufan/deepagents/commit/28cd19db08bacf981ab2c91195638e66072816fe))
* **code:** offload `create_model` in server graph factory to unblock Codex ([#4324](https://github.com/knqiufan/deepagents/issues/4324)) ([064ea0c](https://github.com/knqiufan/deepagents/commit/064ea0c6851353d0b0bc347a0758149765688945))
* **code:** persist resume model state privately ([#4400](https://github.com/knqiufan/deepagents/issues/4400)) ([bbd0f0d](https://github.com/knqiufan/deepagents/commit/bbd0f0d1ddc9d22d399a819d7b4363f7997d119e))
* **code:** persist rubric model after server restart ([#4419](https://github.com/knqiufan/deepagents/issues/4419)) ([5605a68](https://github.com/knqiufan/deepagents/commit/5605a681c9fec888d8c6dfbde2decd4692c8cef0))
* **code:** pin app version when installing extras ([#4313](https://github.com/knqiufan/deepagents/issues/4313)) ([c20c8e2](https://github.com/knqiufan/deepagents/commit/c20c8e2fc138f72f1444107d2a936305a591807b))
* **code:** preserve transcript order during virtualization ([#4549](https://github.com/knqiufan/deepagents/issues/4549)) ([f6ee70c](https://github.com/knqiufan/deepagents/commit/f6ee70c00ac6ad7b1b180155018b794308a18361))
* **code:** preserve uv tool context when installing extras ([#4201](https://github.com/knqiufan/deepagents/issues/4201)) ([fcc616c](https://github.com/knqiufan/deepagents/commit/fcc616cf9bc2bbc7b2dc2574ae8649e2f270dc53))
* **code:** prevent `UnicodeEncodeError` crash in non-interactive mode on legacy Windows consoles ([#4478](https://github.com/knqiufan/deepagents/issues/4478)) ([b1b16cd](https://github.com/knqiufan/deepagents/commit/b1b16cd114d4ee4f077cf5824a0176cd94ebd851))
* **code:** queue `/mcp login` sent before the server connects ([#4533](https://github.com/knqiufan/deepagents/issues/4533)) ([edac82c](https://github.com/knqiufan/deepagents/commit/edac82c837de8e12b58b97ac25acc31f743d4c5d))
* **code:** quiet routine ripgrep installer output ([#4417](https://github.com/knqiufan/deepagents/issues/4417)) ([a52c18d](https://github.com/knqiufan/deepagents/commit/a52c18d3ef8fe462d1289dca8798c51450e0368a))
* **code:** quiet uv installer output and require Xcode CLT on macOS ([#4180](https://github.com/knqiufan/deepagents/issues/4180)) ([785c8d0](https://github.com/knqiufan/deepagents/commit/785c8d0061114f8f3c457d4afc35a83bd405fc1b))
* **code:** re-apply theme preference on `/reload` ([#4514](https://github.com/knqiufan/deepagents/issues/4514)) ([5d1c392](https://github.com/knqiufan/deepagents/commit/5d1c3928f7ca0ea97f28fd4d34ae1a4ee885e888))
* **code:** read `LANGSMITH_PROJECT` for `tracing.langsmith_project` + show default ([#4054](https://github.com/knqiufan/deepagents/issues/4054)) ([fec1551](https://github.com/knqiufan/deepagents/commit/fec1551e901a4fe88bd74ee4833a91ef93b1e93f))
* **code:** record shell output as user context ([#4353](https://github.com/knqiufan/deepagents/issues/4353)) ([0d504a5](https://github.com/knqiufan/deepagents/commit/0d504a5df8454e871597932ce1cd3e95b10ab00e))
* **code:** redact LangSmith trace secrets by default ([#4356](https://github.com/knqiufan/deepagents/issues/4356)) ([5e01fec](https://github.com/knqiufan/deepagents/commit/5e01fec72d8b179a3b075b07268162d2eaebfe84))
* **code:** refocus `/mcp` filter input after in-place refresh ([#4080](https://github.com/knqiufan/deepagents/issues/4080)) ([d79cd74](https://github.com/knqiufan/deepagents/commit/d79cd74cb8a44c300c3bbad712fe77e709f9221a))
* **code:** reject `--auto-approve` in headless mode ([#4617](https://github.com/knqiufan/deepagents/issues/4617)) ([997be16](https://github.com/knqiufan/deepagents/commit/997be1643aff6d6900b8b8c95832cdf93be8c0d7))
* **code:** remove MCP OAuth success page message shift ([#4463](https://github.com/knqiufan/deepagents/issues/4463)) ([69bb06c](https://github.com/knqiufan/deepagents/commit/69bb06c0680fa6d37b917deb6b70927c3eff9c09))
* **code:** remove transient `Restarting server...` message after restart ([#4047](https://github.com/knqiufan/deepagents/issues/4047)) ([87cc504](https://github.com/knqiufan/deepagents/commit/87cc50428bc96ef11dfb11cee4020bff322a7216))
* **code:** report editable SDK runtime version ([#4304](https://github.com/knqiufan/deepagents/issues/4304)) ([4439e91](https://github.com/knqiufan/deepagents/commit/4439e912da4bfa6f1e38e14b5a03d2bfe9367d3b))
* **code:** report same-version dependency updates ([#4146](https://github.com/knqiufan/deepagents/issues/4146)) ([156e118](https://github.com/knqiufan/deepagents/commit/156e1185242a19746f8c268904637c73f07b9a10))
* **code:** rescaffold server workspace on `/restart` when config is missing ([#4050](https://github.com/knqiufan/deepagents/issues/4050)) ([de51b0e](https://github.com/knqiufan/deepagents/commit/de51b0e082293f5f795d96d3bf717c82efb9337e))
* **code:** resolve `/threads` header link on mount, not after load ([#4453](https://github.com/knqiufan/deepagents/issues/4453)) ([4cba728](https://github.com/knqiufan/deepagents/commit/4cba72893fc4aae5b429d8c573c1a513d97ddf8a))
* **code:** resolve editable SDK version metadata ([#4394](https://github.com/knqiufan/deepagents/issues/4394)) ([3239bf4](https://github.com/knqiufan/deepagents/commit/3239bf4edf2be3037bb18315463ac6a0c3537e5c))
* **code:** restore caller's LangSmith API key in shell subprocess env ([#4458](https://github.com/knqiufan/deepagents/issues/4458)) ([9293b19](https://github.com/knqiufan/deepagents/commit/9293b190170a872b73d0d94e66479bcc5f7962c7))
* **code:** restore welcome banner tips ([#4528](https://github.com/knqiufan/deepagents/issues/4528)) ([3f1e55e](https://github.com/knqiufan/deepagents/commit/3f1e55eafbc1fde79cb75f631561cf35d4b8ff4c))
* **code:** route Anthropic effort through output config ([#4446](https://github.com/knqiufan/deepagents/issues/4446)) ([1e8ed81](https://github.com/knqiufan/deepagents/commit/1e8ed81940a862dde44f704826b61650336367e0))
* **code:** run stdio MCP server pre-flight check off the event loop ([#4434](https://github.com/knqiufan/deepagents/issues/4434)) ([c9636e2](https://github.com/knqiufan/deepagents/commit/c9636e22725a5bd32c1f8b9e739b02b4aa7c3dc7))
* **code:** scope `@` file completion to current cwd ([#3874](https://github.com/knqiufan/deepagents/issues/3874)) ([dd237ac](https://github.com/knqiufan/deepagents/commit/dd237acd21a39e98e37bb9d98dfae09bc44d5457))
* **code:** serialize MCP OAuth token refreshes to prevent reuse revocation ([#4565](https://github.com/knqiufan/deepagents/issues/4565)) ([c37100d](https://github.com/knqiufan/deepagents/commit/c37100d4763e527fce12fa4451794ca25ded7640))
* **code:** set dcode agent names in trace metadata ([#3901](https://github.com/knqiufan/deepagents/issues/3901)) ([ac94dd6](https://github.com/knqiufan/deepagents/commit/ac94dd6b139211187cad8685c1152f02c51ba086))
* **code:** show "Loading..." in `/threads` agent dropdown while loading ([#4101](https://github.com/knqiufan/deepagents/issues/4101)) ([c2d949e](https://github.com/knqiufan/deepagents/commit/c2d949e8765fbbbdb81e5a70125932842358099f))
* **code:** show `(local)` tag under ANSI themes ([#4534](https://github.com/knqiufan/deepagents/issues/4534)) ([699e439](https://github.com/knqiufan/deepagents/commit/699e439699723e477a621f95eef87a7d76aac5f5))
* **code:** show loading state during model switch ([#4209](https://github.com/knqiufan/deepagents/issues/4209)) ([7cc4e9f](https://github.com/knqiufan/deepagents/commit/7cc4e9f9bda5a8ae42bb072b82b634ad8c39ade1))
* **code:** show months instead of "0y ago" for 360-364 day old timestamps ([#4267](https://github.com/knqiufan/deepagents/issues/4267)) ([820b331](https://github.com/knqiufan/deepagents/commit/820b331552cb7ce4695ddca3c9b8343a3144392b))
* **code:** skip startup auto-update when already updated in-session ([#3915](https://github.com/knqiufan/deepagents/issues/3915)) ([3ba3471](https://github.com/knqiufan/deepagents/commit/3ba347138ac61a474bad58365fdeaa0d00cc1a42))
* **code:** skip tool interrupts once auto-approve is set ([#4092](https://github.com/knqiufan/deepagents/issues/4092)) ([9e21c34](https://github.com/knqiufan/deepagents/commit/9e21c346a6eb8ad25b9cc671f24527b07732e2b7))
* **code:** strip input before Ctrl+C copy-input fallback ([#4590](https://github.com/knqiufan/deepagents/issues/4590)) ([505d55a](https://github.com/knqiufan/deepagents/commit/505d55ad83e8569213175911ee6c8c39fbbf340c))
* **code:** strip media placeholders from model-facing message text ([#4462](https://github.com/knqiufan/deepagents/issues/4462)) ([aa0ae36](https://github.com/knqiufan/deepagents/commit/aa0ae36b00df6411a9200610a9075ef2dc28b1af))
* **code:** suppress auto-update migration notice on fresh installs ([#4224](https://github.com/knqiufan/deepagents/issues/4224)) ([eb8ff80](https://github.com/knqiufan/deepagents/commit/eb8ff809a1b3130a261083c66a193e532095c6db))
* **code:** suppress expected MCP reauth logs ([#4359](https://github.com/knqiufan/deepagents/issues/4359)) ([15ee384](https://github.com/knqiufan/deepagents/commit/15ee384117ccd955f7481346dd92b7f4b007a60d))
* **code:** suppress model-switch defer toast on bare reconnect ([#4060](https://github.com/knqiufan/deepagents/issues/4060)) ([60b1052](https://github.com/knqiufan/deepagents/commit/60b10520d24c87b9c8c9d85b94cffae9e3c67c43))
* **code:** surface `/auth`-stored credentials in `config show`/`get` ([#4258](https://github.com/knqiufan/deepagents/issues/4258)) ([c7c8788](https://github.com/knqiufan/deepagents/commit/c7c8788ecf0068914298a6055a5f3fd31c36bd44))
* **code:** surface recommended models missing from installed provider profiles ([#4057](https://github.com/knqiufan/deepagents/issues/4057)) ([56e0d31](https://github.com/knqiufan/deepagents/commit/56e0d31b6c507d5a1e95c3f2058a8d3b9488a4db))
* **code:** surface untracked files in `@` completion ([#3872](https://github.com/knqiufan/deepagents/issues/3872)) ([2bdf6ea](https://github.com/knqiufan/deepagents/commit/2bdf6ea329c6b4c8be5f0075528e00c7ce2c1e6a))
* **code:** switch input mode without flashing the mode trigger ([#4243](https://github.com/knqiufan/deepagents/issues/4243)) ([fc5d9cb](https://github.com/knqiufan/deepagents/commit/fc5d9cb8fb978ec95f98407692d4809ea1e86577))
* **code:** sync approval toggles during active runs ([#4239](https://github.com/knqiufan/deepagents/issues/4239)) ([4600365](https://github.com/knqiufan/deepagents/commit/4600365ea0b60c3e9113ecf59b5336be37d03428))
* **code:** unblock MCP force reconnect modal ([#4396](https://github.com/knqiufan/deepagents/issues/4396)) ([8b7eab0](https://github.com/knqiufan/deepagents/commit/8b7eab023db686f577d16f4f9ac872205baf136f))
* **code:** unpin uv self-updates and warn when a stale dcode shadows PATH ([#4185](https://github.com/knqiufan/deepagents/issues/4185)) ([8ca0a18](https://github.com/knqiufan/deepagents/commit/8ca0a185a15f800267cc057178a348fb5063df1e))
* **code:** warn on `/trace` when thread has no messages ([#4162](https://github.com/knqiufan/deepagents/issues/4162)) ([c338fc9](https://github.com/knqiufan/deepagents/commit/c338fc914fcd383beb4b97c13f53dfb2684f8c90))
* **code:** warn on misconfigured subagent files ([#3873](https://github.com/knqiufan/deepagents/issues/3873)) ([f1614d6](https://github.com/knqiufan/deepagents/commit/f1614d67827c3d4d3bd01a784f57f83a50ec3410))
* **code:** word-delete backspace parity in ask-user text area ([#4079](https://github.com/knqiufan/deepagents/issues/4079)) ([ed3c499](https://github.com/knqiufan/deepagents/commit/ed3c499354467bc5e8476e5c7cdf0cd5f8b6aec1))
* **sdk,code:** rename trace version metadata to `lc_versions` ([#3928](https://github.com/knqiufan/deepagents/issues/3928)) ([27f38c5](https://github.com/knqiufan/deepagents/commit/27f38c51f960941e102dfc2f9c0220bc16736749))


### Performance Improvements

* **code:** background refresh for `@` file completion cache ([#3911](https://github.com/knqiufan/deepagents/issues/3911)) ([aa22d6b](https://github.com/knqiufan/deepagents/commit/aa22d6b6d5a49e4d6c3aa2d4932df75d14d65f78))
* **code:** make `threads list` fast on large session databases ([#4005](https://github.com/knqiufan/deepagents/issues/4005)) ([85ca01a](https://github.com/knqiufan/deepagents/commit/85ca01a43b002c2bdb4205f48fac5fa6f66a3276))
* **code:** speed up shutdown after Ctrl+C/Ctrl+D ([#4351](https://github.com/knqiufan/deepagents/issues/4351)) ([db441ed](https://github.com/knqiufan/deepagents/commit/db441ed306a8e03fb68f2ae6a2c08523e248976d))
